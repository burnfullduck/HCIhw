<template>
    <div>
        ...
        <div class="container" style="margin-left:160px">
            ...
            <div v-show="pageType === 'basic'" class="api jumbotron p-3 p-md-5 text-black rounded back-white"
                style="height: auto;">
                <h3 class="md-3">输入文本来源选择</h3>
                <el-radio v-model="inputType" label="text">英文文本</el-radio>
                <el-radio v-model="inputType" label="trans">中文文本</el-radio>
                <el-radio v-model="inputType" label="file">文件</el-radio>
                <el-radio v-model="inputType" label="fileFolder">文件夹</el-radio>
            ...
            <div v-show="pageType === 'premium'" class="jumbotron p-3 p-md-5 text-black rounded back-white">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-text">
                        <div class="checkbox">
                            <label><input class="form-check-input" type="checkbox" v-model="setKeywards" value="keywords"
                                    @change="showKeywords = !showKeywords">是否设定关键词</label>
                        </div>
                    </div>
                    <input id="kwds" type="text" class="form-control" v-model="keywards" placeholder="[逗号分隔的列表]"
                        v-if=showKeywords>
                </div>
                ...
                <div class="input-group mb-3" v-if=showKeywords>
                    <div class="input-group-text">
                        <div class="checkbox">
                            <label><input class="form-check-input" type="checkbox" v-model="setWordsBeforeKeywords"
                                    @change="showWordsBeforeKeywords = !showWordsBeforeKeywords"
                                    value="keywords">设定在关键字之前分类的单词数(默认为4)</label>
                        </div>
                    </div>
                    <input type="text" class="form-control" v-model="wordsBeforeKeywords" placeholder="大于等于0的整数"
                        v-if=showWordsBeforeKeywords>
                </div>

                <div class="input-group mb-3" v-if=showKeywords>
                    <div class="input-group-text">
                        <div class="checkbox">
                            <label><input class="form-check-input" type="checkbox" v-model="setWordsAfterKeywords"
                                    @change="showWordsAfterKeywords = !showWordsAfterKeywords"
                                    value="keywords">设定在关键字之前分类的单词数(默认为4)</label>
                        </div>
                    </div>
                    <input type="text" class="form-control" v-model="wordsAfterKeywords" placeholder="大于等于0的整数"
                        v-if=showWordsAfterKeywords>
                </div>
            ...
            <div v-show="pageType === 'premium'" class="jumbotron p-3 p-md-5 text-white rounded back-dark"
                ...
                <div class="form-check" v-if=setNegatingWordsOccurAfterSentiment>
                    ...
                    <input type="text" class="form-check" v-model="maxWordsAfterSentimentToNegate" placeholder="大于等于0的整数"
                        v-if=showMaxWordsAfterSentimentToNegate>
                </div>
                <div class="form-check">
                ...
                <div class="form-check" v-if=setNegatingWordsDontOccurBeforeSentiment>
                    ...
                    <input type="text" class="form-check" v-model="maxWordsBeforeSentimentToNegate" placeholder="大于等于0的整数"
                        v-if=showMaxWordsBeforeSentimentToNegate>
                </div>
                <div class="form-check">
